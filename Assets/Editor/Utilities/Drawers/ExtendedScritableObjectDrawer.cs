...
/// </summary>
/// <para>
/// I used this in my <see cref="Assignment1.Animations.TweenSequencer"/> So I can quickly modify my <see cref="Assignment1.Animations.TweenDatum"/> <see cref="ScriptableObject"/>.
/// </para>
/// <para>
/// Taken from here https://gist.github.com/tomkail/ba4136e6aa990f4dc94e0d39ec6a058c
/// </para>
/// <!---->
...
public class ExtendedScriptableObjectDrawer : PropertyDrawer {
	...
	public override float GetPropertyHeight(SerializedProperty property, GUIContent label) {
		...
		if (!IsThereAVisibleProperty(property))
			return totalHeight;
	...
	public bool IsThereAVisibleProperty(SerializedProperty property) {
		var data = (ScriptableObject) property.objectReferenceValue;
		SerializedObject serializedObject = new SerializedObject(data);
